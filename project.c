...
*/
	...
	case 43: 	// sw ++++++++++++++
		...
		break;
	case 15: 	// lui --------------
		controls->RegDst = 1; // asserted as writing to rt (slide Processor 48)
		controls->ALUSrc = 1; // asserted for sign-extended 16 bits
		controls->MemtoReg = 0;
		controls->RegWrite = 1;
		controls->MemRead = 0;
		controls->MemWrite = 0;
	...
	if(ALUControl == 7)
		switch (funct) {
			...
			case 37: // or
				ALUControl = 5;
				break;
			case 4: // shift left right variable
				ALUControl = 6;
				break;
			case 39: // nor
				ALUControl = 7;
				break;
			default: // any invalid op
				return 1; // halt
	}
...
void PC_update(unsigned jsec, unsigned extended_value, char Branch, char Jump, char Zero, unsigned *PC)
{
	...
	*PC += 4;
	...
	// jump to the register and multiply by 4 
	else if (Jump)
